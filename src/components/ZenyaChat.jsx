...
const guestFAQAnswers = {
  'what classes are available': `We offer A/L classes at XenEdu Mirigama:\n\nð Science Stream:\nâ¢ Physics\nâ¢ Chemistry\nâ¢ Biology\nâ¢ Combined Mathematics\n\nð Commerce Stream:\nâ¢ Accounting\nâ¢ Economics\nâ¢ Business Studies\n\nð» Technology: ICT\nð Languages: English, Sinhala\n\nAvailable for Grade 12 & 13 in Sinhala, Tamil and English mediums! ð`,
  'how do i pay my fees': `At XenEdu, you can pay fees in 3 ways:\n\nðµ Cash â Pay at the institute counter.\nð³ Card â Pay by debit/credit card.\nð¦ Bank Transfer â Transfer and upload slip via portal.\n\nð Bank: Bank of Ceylon\nð¢ Account: 1234-5678-9012\nð¢ Branch: Mirigama\n\nð 033-2242-2589 for more details! ð`,
  'what is the attendance policy': `XenEdu requires minimum 80% attendance.\n\nð Attendance marked using student ID barcode.\nâ ï¸ If attendance drops below 80%, parents get an alert.\n\nRegular attendance is key to A/L success! ðª`,
  'how do i enroll in a class': `Enrolling at XenEdu is simple! ð\n\n1ï¸â£ Register â Fill your details online.\n2ï¸â£ Admin Approval â Get login via email.\n3ï¸â£ Browse & Enroll â Login and enroll in subjects.\n4ï¸â£ Pay Fees â Counter or bank transfer.\n\nNeed help? Call ð 033-2242-2589! ð`,
  'what are the class timings': `Class timings vary by subject and teacher.\n\nâ° Morning: 7:00 AM - 12:00 PM\nâ° Evening: 2:00 PM - 7:00 PM\nð Weekdays and weekends\n\nð 033-2242-2589\nð§ xenedu@gmail.com`,
  'how can i view my results': `Track your progress via the student portal:\n\nð Attendance %, payment history, enrolled classes and outstanding fees.\n\nParents can monitor via the parent portal! ð¨âð©âð§\n\nExam results are provided directly by teachers.`,
};
...
const getGuestReply = (message) => {
  ...
  if (lower.includes('hello') || lower.includes('hi') || lower.includes('hey')) return "Hi there! ð I'm Zenya, XenEdu's AI assistant!\n\nAsk me about classes, fees, enrollment and more! ð";
  if (lower.includes('contact') || lower.includes('address')) return "ð XenEdu Mirigama\nð 033-2242-2589\nð§ xenedu@gmail.com\n\nMon-Fri: 8AM-6PM | Sat: 8AM-4PM";
  if (lower.includes('price') || lower.includes('cost')) return "Fees: Rs. 2,000 - Rs. 3,500/month depending on subject.\n\nð 033-2242-2589";
  return "Thanks for your question! ð\n\nI can help with classes, fees, enrollment and schedules.\n\nð 033-2242-2589\nð§ xenedu@gmail.com";
};
  ...
  const sendMessage = async (text) => {
    ...
    try {
      ...
      setMessages(prev => [...prev, {
        role: 'assistant',
        content: isQuota
          ? 'â° AI quota exceeded! Please try again later.'
        ...
        >
            ...
            <View style={styles.headerLeft}>
              ...
              <View>
                ...
                <Text style={styles.headerStatus}>
                  {user ? 'Online â XenEdu AI Assistant' : 'Online â Ask me anything!'}
                </Text>
              </View>
            </View>
          ...
          {!started ? (
            ...
            <ScrollView style={styles.welcomeScroll} contentContainerStyle={styles.welcomeContent}>
              ...
              <Text style={styles.welcomeTitle}>
                Hi, I'm <Text style={{ color: COLORS.primary }}>Zenya</Text> ð
              </Text>
                ...
                {faqs.slice(0, 4).map((faq, i) => (
                  ...
                  >
                    <View style={styles.faqArrow}>
                      <Text style={styles.faqArrowText}>â</Text>
                    </View>
            ...
            <>
              ...
              <View style={styles.inputContainer}>
                ...
                <Text style={styles.inputHint}>Enter to send â¢ Shift+Enter for new line</Text>
              </View>
            </>
          )}
          ...
          {!started && (
            <View style={styles.startBtnContainer}>
              ...
              >
                <Text style={styles.startBtnText}>Start Conversation â</Text>
              </TouchableOpacity>
            </View>
          )}
        </KeyboardAvoidingView>
...
fab: {
  position: 'absolute',
  bottom: 20,   // â more space from bottom
  right: 24,     // â more space from right edge
  zIndex: 999,
},
fabBtn: {
  ...
  elevation: 10,
  position: 'relative',  // â needed for dot positioning
},
fabImage: {
  width: 64, height: 64,  // â exact size
  borderRadius: 32,
},
fabOnlineDot: {
  position: 'absolute',
  bottom: -19,      // â inside button
  right: -12,       // â inside button
  width: 14, height: 14, borderRadius: 8,
  backgroundColor: '#00C853',
  borderWidth: 2.5, borderColor: COLORS.white,
  zIndex: 10,     // â on top of image
  elevation: 5,
},
