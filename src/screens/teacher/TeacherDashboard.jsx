                    ...
                    {pct !== null && (
                      <View style={sStyles.attSection}>
                        <View style={sStyles.attBar}>
                          <View style={[sStyles.attFill, {
                            width: `${pct}%`,
                            backgroundColor: pct >= 80 ? '#10B981' : '#EF4444',
                          }]} />
                        </View>
                        ...
                        {pct < 80 && (
                          <Text style={sStyles.attWarning}>⚠️ Below 80% minimum</Text>
                        )}
                      </View>
                    )}
                  </View>
...
const TeacherDashboard = () => {
  ...
  const totalStudents = myClasses?.classes?.reduce((s, c) => s + (c.enrolledCount || 0), 0) || 0;
...
const styles = StyleSheet.create({
  ...
  studentsBtn: {
    ...
    gap: 6, backgroundColor: '#F0FBF7', borderRadius: 10, paddingVertical: 10,
