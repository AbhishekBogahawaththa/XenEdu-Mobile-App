...
const styles = StyleSheet.create({
  ...
  statCard: { width: '47%', backgroundColor: COLORS.white, borderRadius: 16, padding: 14, elevation: 2 },
  ...
  actionCard: { width: '47%', backgroundColor: COLORS.white, borderRadius: 16, padding: 16, alignItems: 'center', elevation: 2 },
  actionIcon: { width: 52, height: 52, borderRadius: 14, alignItems: 'center', justifyContent: 'center', marginBottom: 8, position: 'relative' },
  ...
  classRow: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: COLORS.white, borderRadius: 12, padding: 12, marginBottom: 8, elevation: 1 },
  classIcon: { width: 36, height: 36, borderRadius: 10, backgroundColor: '#F0FBF7', alignItems: 'center', justifyContent: 'center' },
  classInfo: { flex: 1 },
